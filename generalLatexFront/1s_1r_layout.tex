...
\begin{tikzpicture}[]
    	...
    	% instructions
    	\node[anchor = north west] at (\sendInstructionsX, \sendInstructionsY) { \instructionFormatting{\instructionsOne} } ;
    	\node[anchor = north west] at (\sendInstructionsX, \sendInstructionsY-0.5) { \instructionFormatting{\instructionsTwo} } ;
			\node[anchor = north west] at (\sendInstructionsX, \sendInstructionsY-1) { \instructionFormatting{\instructionsThree} } ;
			\node[anchor = north west] at (\sendInstructionsX, \sendInstructionsY-1.5) { \instructionFormatting{\instructionsFour} } ;
