...
\begin{tikzpicture}[]
    	...
    	% instructions
    	\node[anchor = south east] at (\recipInstructionsX, \recipInstructionsY+1) { \instructionFormatting{\instructionsOne} } ;
			\node[anchor = south east] at (\recipInstructionsX, \recipInstructionsY) { \instructionFormatting{\instructionsThree} } ;
    	\node[anchor = south east] at (\recipInstructionsX, \recipInstructionsY+0.5) { \instructionFormatting{\instructionsTwo} } ;
			\node[anchor = south east] at (\recipInstructionsX, \recipInstructionsY) { \instructionFormatting{\instructionsThree} } ;
