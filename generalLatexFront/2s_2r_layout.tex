...
\begin{tikzpicture}[]
    	...
    	\node[anchor = north west] at (\sendInstructionsX, \sendInstructionsY) { \instructionFormatting{\instructionsOneS} } ;
			\node[anchor = north west] at (\sendInstructionsX, \sendInstructionsY-0.5) { \instructionFormatting{\instructionsTwoS} } ;
			% instructions - recipient
	\node[anchor = south east] at (\recipInstructionsX, \recipInstructionsY+0.5) { \instructionFormatting{\instructionsOneR} } ;
