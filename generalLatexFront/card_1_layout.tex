...
\begin{tikzpicture}[]	
    	...
    	% instructions
    	\node[anchor = north west] at (-1.5, 0.9) { \instructionFormatting{\instructionsOne} } ;
    	\node[anchor = north west] at (-1.5, 0.4) {\instructionFormatting{\instructionsTwo}} ;
    	\node[anchor = north west] at (-1.5, -0.1) {\instructionFormatting{\instructionsThree}} ;		
\end{tikzpicture}