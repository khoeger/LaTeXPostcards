...
\newcommand{\senderNAnchor}{1.5}
\newcommand{\recipSAnchor}{-2.03}
...
%    	\node[anchor=north east, rotate = 90, text = black!20!white] at (\lrMarginStart,\senderNAnchor) {\personSty{\sender}};
    	...
    	% recipient label - on
    	\node[anchor=north east, rotate = -90 ] at (\lrMarginStart, \recipSAnchor) {\personSty{\recipient}};
%    	% recipient label - off
%    	\node[anchor=north east, rotate = -90, text = black!20!white ] at (\lrMarginStart,\recipSAnchor) {\personSty{\recipient}}
