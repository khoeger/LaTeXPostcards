...
% --- Packages
\usepackage[paperwidth= \cardWidth in, paperheight=\cardHeight in,
						top=0 in, bottom=0 in, left=0 in, right=0 in]{geometry}
\usepackage{tikz} 			% drawing functions & foreach
...
% Card 2 Recpient Card Special Values (Card 19)
								...
								}
								{
									...
									}
									{
										...
										}
										{
											...
											{
												% card 19
												\input{card_19_constants.tex}
												% generate 3:2:1
												\input{generate_3s1Line_2r1Line_1r2Line.tex}
											}
										}
									}
								}
